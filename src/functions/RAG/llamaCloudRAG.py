...
async def llama_cloud_rag(input: dict) -> dict:
    ...
    try:
        ...
        index = LlamaCloudIndex(
            name="Companies Index Text Version",
            project_name="CraftConnect-Praxis",
            organization_id="38e2798d-2cf1-43f3-b7cf-d1bb76b5c455",
        ...
        llm_together = TogetherLLM(
            model="meta-llama/Llama-3.3-70B-Instruct-Turbo",
            api_key=required_keys["TOGETHER_API_KEY"],
            timeout=60
        )
